...
### [Minikube installation](https://docs.k8s.ru/tools/containers/kubernetes/minikube/setup/)
...
### [Kubectl installation](https://docs.k8s.ru/tools/containers/kubernetes/utils/kubectl/)
...
Если использовать docker или kvm, можно посмотреть [здесь](https://docs.k8s.ru/tools/containers/kubernetes/minikube/setup/remote-connection-docker/)
