...
# Попытка запустить Job в ранее установленном <a href="/tools/git/gitlab/setup/ubuntu/">GitLab</a>
...
Для начала, установлю <a href="https://docs.sysadm.ru/devops/tools/containers/docker/setup/ubuntu/">docker</a>
