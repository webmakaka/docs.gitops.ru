...
### [Инсталляция Argo Events](/tools/containers/kubernetes/utils/ci-cd/argo/argo-events/setup/)

### [Инсталляция Argo Image Updater](/tools/containers/kubernetes/utils/ci-cd/argo/argo-image-updater/setup/)
