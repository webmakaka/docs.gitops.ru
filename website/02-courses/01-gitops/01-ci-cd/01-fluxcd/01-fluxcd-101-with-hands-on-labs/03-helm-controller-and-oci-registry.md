...
permalink: /courses/gitops/ci-cd/fluxcd/fluxcd-101-with-hands-on-labs/helm-controller-and-oci-registry/
---
...
[Устанавливаю helm](https://docs.k8s.ru/tools/containers/kubernetes/utils/helm/setup/)
