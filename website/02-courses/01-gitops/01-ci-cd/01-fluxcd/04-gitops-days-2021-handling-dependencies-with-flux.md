...
permalink: /courses/gitops/ci-cd/fluxcd/gitops-days-2021-handling-dependencies-with-flux/
---
...
[Инсталляция Linkerd](https://docs.k8s.ru/tools/containers/kubernetes/utils/service-mesh/linkerd/setup/)
